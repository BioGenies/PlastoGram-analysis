...
Model with case weights, QuiPT cut-off = 0.001
```{r}
kable(Stroma_cases_CV_res_stats)
kable(table(Stroma_cases_CV[["target"]], Stroma_cases_CV[["pred"]]))
```
...
Model with case weights, QuiPT cut-off = 0.001
```{r}
kable(OM_Stroma_cases_CV_res_stats)
kable(table(OM_Stroma_cases_CV[["target"]], OM_Stroma_cases_CV[["pred"]]))
```
...
print(paste0("plastogram_CV accuracy: ", ACC(plastogram_CV[["dataset"]], plastogram_CV[["Decision"]])))
```
...
print(paste0("plastogram_cases_CV accuracy: ", ACC(plastogram_cases_CV[["dataset"]], plastogram_cases_CV[["Decision"]])))
```
...
print(paste0("plastogram_decision_model_CV accuracy: ", ACC(plastogram_decision_model_CV[["dataset"]], plastogram_decision_model_CV[["prediction"]])))
```
...
print(paste0("plastogram_decision_model_cases_CV accuracy: ", ACC(plastogram_decision_model_cases_CV[["dataset"]], plastogram_decision_model_cases_CV[["prediction"]])))
```
...
print(paste0("plastogram_decision_model_for_all_CV accuracy: ", ACC(plastogram_decision_model_for_all_CV[["dataset"]], plastogram_decision_model_for_all_CV[["prediction"]])))
```
...
print(paste0("plastogram_decision_model_for_all_cases_CV accuracy: ", ACC(plastogram_decision_model_for_all_cases_CV[["dataset"]], plastogram_decision_model_for_all_cases_CV[["prediction"]])))
```
...
print(paste0("plastogram_stroma_and_decision_model_cases_CV accuracy: ", ACC(plastogram_stroma_and_decision_model_cases_CV[["dataset"]], plastogram_stroma_and_decision_model_cases_CV[["prediction"]])))
```

Models with QuiPT cut-off = 0.001, with case weights, with stroma model, with decision model for all
```{r}
kable(table(plastogram_stroma_and_decision_model_for_all_cases_CV[["dataset"]], plastogram_stroma_and_decision_model_for_all_cases_CV[["prediction"]]))
print(paste0("plastogram_stroma_and_decision_model_for_all_cases_CV accuracy: ", ACC(plastogram_stroma_and_decision_model_for_all_cases_CV[["dataset"]], plastogram_stroma_and_decision_model_for_all_cases_CV[["prediction"]])))
```

Models with QuiPT cut-off = 0.001, without case weights, with OM_Stroma model, with decision model
```{r}
kable(table(plastogram_OM_stroma_and_decision_model_CV[["dataset"]], plastogram_OM_stroma_and_decision_model_CV[["prediction"]]))
print(paste0("plastogram_OM_stroma_and_decision_model_CV accuracy: ", ACC(plastogram_OM_stroma_and_decision_model_CV[["dataset"]], plastogram_OM_stroma_and_decision_model_CV[["prediction"]])))
```

Models with QuiPT cut-off = 0.001, with case weights, with OM_Stroma model, with decision model
```{r}
kable(table(plastogram_OM_stroma_and_decision_model_cases_CV[["dataset"]], plastogram_OM_stroma_and_decision_model_cases_CV[["prediction"]]))
print(paste0("plastogram_OM_stroma_and_decision_model_cases_CV accuracy: ", ACC(plastogram_OM_stroma_and_decision_model_cases_CV[["dataset"]], plastogram_OM_stroma_and_decision_model_cases_CV[["prediction"]])))
```
